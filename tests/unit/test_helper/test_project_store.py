...
def test_project_paths_create_directories(temp_dir: Path, monkeypatch: object) -> None:
...
def test_init_project_writes_metadata_and_returns_paths(
    temp_dir: Path, monkeypatch: object
) -> None:
...
def test_init_project_allows_overrides(temp_dir: Path, monkeypatch: object) -> None:
    ...
    assert data["project"]["browser_config"]["viewport"] == {"width": 1440, "height": 900}
